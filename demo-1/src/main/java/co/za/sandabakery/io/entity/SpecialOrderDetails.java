...
public class SpecialOrderDetails implements Serializable {
	...
	public SpecialOrderDetails(Long id, String specialOrderId, ProductEntity product, int quantity, double price,
			Order order) {
		super();
		this.id = id;
